...
public class VoidBruteEntity extends IdkModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("void_brute").setRegistryName("void_brute");
	public VoidBruteEntity(IdkModElements instance) {
		super(instance, 45);
		FMLJavaModLoadingContext.get().getModEventBus().register(new VoidBruteRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6749953, -16777216, new Item.Properties().group(VoidItemsItemGroup.tab))
				.setRegistryName("void_brute_spawn_egg"));
	}
