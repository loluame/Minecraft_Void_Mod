...
public class VoidFenceBlock extends IdkModElements.ModElement {
	@ObjectHolder("idk:void_fence")
	public static final Block block = null;
	public VoidFenceBlock(IdkModElements instance) {
		super(instance, 32);
	}
