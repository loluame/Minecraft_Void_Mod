...
public class VoidBrickBlock extends IdkModElements.ModElement {
	@ObjectHolder("idk:void_brick")
	public static final Block block = null;
	public VoidBrickBlock(IdkModElements instance) {
		super(instance, 30);
	}
