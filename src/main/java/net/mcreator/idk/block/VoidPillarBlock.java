...
public class VoidPillarBlock extends IdkModElements.ModElement {
	@ObjectHolder("idk:void_pillar")
	public static final Block block = null;
	public VoidPillarBlock(IdkModElements instance) {
		super(instance, 31);
	}
