...
public class VoidSlabBlock extends IdkModElements.ModElement {
	@ObjectHolder("idk:void_slab")
	public static final Block block = null;
	public VoidSlabBlock(IdkModElements instance) {
		super(instance, 33);
	}
