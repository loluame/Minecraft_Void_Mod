...
public class VoidLeavesBlock extends IdkModElements.ModElement {
	@ObjectHolder("idk:void_leaves")
	public static final Block block = null;
	public VoidLeavesBlock(IdkModElements instance) {
		super(instance, 54);
	}
