...
public class VoiddustItem extends IdkModElements.ModElement {
	@ObjectHolder("idk:voiddust")
	public static final Item block = null;
	public VoiddustItem(IdkModElements instance) {
		super(instance, 4);
	}
