...
public class VoidStickItem extends IdkModElements.ModElement {
	@ObjectHolder("idk:void_stick")
	public static final Item block = null;
	public VoidStickItem(IdkModElements instance) {
		super(instance, 22);
	}
